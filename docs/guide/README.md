# Omega programmer guides

This directory is explanatory and task-oriented. It is intentionally easier to skim than the normative language definition.
...
If a guide conflicts with [`../language/`](../language/), the language documentation wins for semantics.
