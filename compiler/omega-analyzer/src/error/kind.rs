    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::GlueMissingFunction { gap, function } => {
                write!(f, "glue for gap '{}' is missing function '{}'", gap.as_ref(), function.as_ref())
            }
            Self::GlueExtraFunction { gap, function } => {
                write!(f, "glue for gap '{}' has no function '{}'", gap.as_ref(), function.as_ref())
            }
            Self::GlueFunctionSignatureMismatch { gap, function } => {
                write!(f, "glue function '{}' does not match gap '{}'", function.as_ref(), gap.as_ref())
            }
